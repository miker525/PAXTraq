<%@ Page Title="Two-Factor Authentication" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="TwoFactorAuthenticationSignIn.aspx.vb" Inherits="PAXTraq.TwoFactorAuthenticationSignIn" %>
